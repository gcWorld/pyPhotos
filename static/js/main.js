...
var Weather = {
	init: function(){
		this.getWeather('c9d417b22edc92cf','UK','Bristol');
	},
...
var Clock = {
  ...
  refresh: function() {
	...
	Clock.$el.digital.time.html("<span class='hour'>"+parts.hour+"</span> : "+"<span class='minute'>"+parts.minute+"</span>"+" : <span class='second hidden'>"+parts.second+"</span");
  },
